...
\[7.7.0-alpha] - 2026-04-07
大改排班系统

\[7.6.4-alpha] - 2026-03-26
新增 队员可以修改自己的信息
修改后管理员审核

\[7.6.3-alpha] - 2026-03-14
修复人员须择可以 中文 全拼 首字母搜索

\[7.6.2-alpha] - 2026-03-14
出差页增加数据统计

\[7.6.1-alpha] - 2026-03-13
修复出差模块队员收不到通知
...
\[7.5.0-alpha] - 2026-02-22
删除聊天功能

\[7.4.2-alpha] - 2026-02-18
美化所有前端文件

\[7.4.1-alpha] - 2026-02-18
增加管理员重置队员密码功能
统一分页控件为公共控件

\[7.4.0-alpha] - 2026-02-17
增加资产快速扫码盘点
解构资产前端文件
修改服务为ssl证书访问

\[7.3.1-alpha] - 2026-02-13
丰富请假类型
丰富请假类型前端颜色
请假模块增加是否上报字段
请假人员名单增加排序
...
集成 log\_action 函数，登记出差与确认归队操作将自动同步至系统审计流。
...
404 路由冲突：修复了出差蓝图（trip\_bp）在未统一配置 url\_prefix 情况下导致的地址栏访问错误，明确了 /trip/list 访问规范。
...
- **账号自动同步**：现在“自主登记”的队员在通过管理员审批（approve\_pending）后，系统会自动为其创建登录账号。
- **默认凭据生成**：自动创建的账号统一以 身份证号 为用户名，身份证后六位 为初始密码。
- **操作审计流**：在审批通过时，系统会自动记录一条 action\_type='审批入职' 的审计日志到数据库中，涵盖审批人、目标对象及具体描述。
